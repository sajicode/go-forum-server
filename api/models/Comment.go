...
// SaveComment - save a comment to a post
...
// GetComments - get all comments of a post
...
// UpdateAComment - update a single comment
...
// DeleteAComment - delete a single comment
