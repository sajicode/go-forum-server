...
func (p *Post) Validate() map[string]string {
	...
	if p.AuthorID < 1 {
		err = errors.New("Author is required")
...
// FIndAllPosts - find first 100 posts
...
// FindPostByID - Find a single post
...
// UpdateAPost - update a single post
...
// DeleteAPost - delete a single post
...
// FindUserPosts - get all posts belonging to a user
