...
// DeleteLike - delete a like to a post
func (l *Like) DeleteLike(db *gorm.DB) (*Like, error) {
	...
	if err != nil {
		...
		//* If the like exists, save it in deleted like and delete it
		deletedLike = l
...
// GetLikesInfo - get information on all likes of a post
