...
var (
	// SendMail - this is useful when we start testing
...
// SendResetPassword - handles password reset
func (s *sendMail) SendResetPassword(ToUser string, FromAdmin string, Token string, Sendgridkey string, AppEnv string) (*EmailResponse, error) {
	h := hermes.Hermes{
		Product: hermes.Product{
			Name: "SeamFlow", //change to app title later
			Link: "https://seamflow.com", //change to react url later
		},
	}
